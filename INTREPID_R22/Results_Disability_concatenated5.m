...
%     params.scale_ART_rec2 = tmp.scale_ART_rec;
    ...
    if isfile(filename)==0
        Status_quo = model_proj5(params,SS,0,Disability_weights,Disability_weights_PWID,Disability_weights_HIV,ARTUnitCost,OSTUnitCost,NSPUnitCost);
    ...
    if isfile(filename)==0
        OST_50_2030 = model_proj5(params,SS,1,Disability_weights,Disability_weights_PWID,Disability_weights_HIV,ARTUnitCost,OSTUnitCost,NSPUnitCost);
    ...
    if isfile(filename)==0
        ART_50_2030 = model_proj5(params,SS,2,Disability_weights,Disability_weights_PWID,Disability_weights_HIV,ARTUnitCost,OSTUnitCost,NSPUnitCost);
        save(filename,'ART_50_2030')
    end
    % Scale-up ART to 50% 2030 target
    filename = [dir,'/ARTOST_50_2030_',num2str(k),'.mat'];
    if isfile(filename)==0
        ARTOST_50_2030 = model_proj5(params,SS,3,Disability_weights,Disability_weights_PWID,Disability_weights_HIV,ARTUnitCost,OSTUnitCost,NSPUnitCost);
    ...
    if isfile(filename)==0
        NSP_50_2030 = model_proj5(params,SS,4,Disability_weights,Disability_weights_PWID,Disability_weights_HIV,ARTUnitCost,OSTUnitCost,NSPUnitCost);
        save(filename,'NSP_50_2030')
    end   
     % Scale-up ART to 50% 2030 target
    filename = [dir,'/NSPART_50_2030_',num2str(k),'.mat'];
    if isfile(filename)==0
        NSPART_50_2030 = model_proj5(params,SS,5,Disability_weights,Disability_weights_PWID,Disability_weights_HIV,ARTUnitCost,OSTUnitCost,NSPUnitCost);
    ...
    if isfile(filename)==0
        NSPOST_50_2030 = model_proj5(params,SS,6,Disability_weights,Disability_weights_PWID,Disability_weights_HIV,ARTUnitCost,OSTUnitCost,NSPUnitCost);
    ...
    if isfile(filename)==0
        NSPARTOST_50_2030 = model_proj5(params,SS,7,Disability_weights,Disability_weights_PWID,Disability_weights_HIV,ARTUnitCost,OSTUnitCost,NSPUnitCost);
