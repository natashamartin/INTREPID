function ABC_output = ABC1(priors,N,stopping_criteria,alpha,sigma_scale,seed,Tol_length,ISO,num)
tic
...
%     if t==stopping_criteria %Tolerance_new/Tolerance_old>stoping_criteria
%         stop=1;
%     end
