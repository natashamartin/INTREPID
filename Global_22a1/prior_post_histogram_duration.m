function prior_post_histogram_duration(N, posteriors, priors, ISO, scenario,duration)
close all
...
%     close all
    ...
    filename = ['Outputs/',ISO,'/',num2str(duration),'hrs/scenario_',num2str(scenario),'/Histograms/',ISO,'_',char(fields(j)),'.png'];
    saveas(fig,filename)
...
filename = ['Outputs/',ISO,'/',num2str(duration),'hrs/scenario_',num2str(scenario),'/Histograms/',ISO,'_multi1.png'];
saveas(fig_multi1,filename)

filename = ['Outputs/',ISO,'/',num2str(duration),'hrs/scenario_',num2str(scenario),'/Histograms/',ISO,'_multi2.png'];
