...
tmp2 = Status_quo.PWID_HCV_chronic_prevalence;
...
tmp2 = ART_50_2030.PWID_HCV_chronic_prevalence;
...
tmp2 = OST_50_2030.PWID_HCV_chronic_prevalence;
...
tmp2 = ARTOST_50_2030.PWID_HCV_chronic_prevalence;
...
tmp2 = NSP_50_2030.PWID_HCV_chronic_prevalence;
...
tmp2 = NSPART_50_2030.PWID_HCV_chronic_prevalence;
...
tmp2 = NSPOST_50_2030.PWID_HCV_chronic_prevalence;
...
tmp2 = NSPARTOST_50_2030.PWID_HCV_chronic_prevalence;
...
Filename2 = [outputfolder,'/4.summarytable2.HCV_SQ_', datestr(now, 'yyyy-mm-dd'),'.csv'];
...
Filename2 = [outputfolder,'/4.summarytable2.HCV_ART_', datestr(now, 'yyyy-mm-dd'),'.csv'];
...
Filename2 = [outputfolder,'/4.summarytable2.HCV_OST_', datestr(now, 'yyyy-mm-dd'),'.csv'];
...
Filename2 = [outputfolder,'/4.summarytable2.HCV_NSP_', datestr(now, 'yyyy-mm-dd'),'.csv'];
...
Filename2 = [outputfolder,'/4.summarytable2.HCV_ARTOST_', datestr(now, 'yyyy-mm-dd'),'.csv'];
...
Filename2 = [outputfolder,'/4.summarytable2.HCV_NSPART_', datestr(now, 'yyyy-mm-dd'),'.csv'];
...
Filename2 = [outputfolder,'/4.summarytable2_NSPOST_', datestr(now, 'yyyy-mm-dd'),'.csv'];
...
Filename2 = [outputfolder,'/4.summarytable2_NSPARTOST_', datestr(now, 'yyyy-mm-dd'),'.csv'];
...
Filename2 = [outputfolder,'/4.summarytable3_infectionavered_', datestr(now, 'yyyy-mm-dd'),'.csv'];
