function prior_post_histogram_combined(N, posteriors, priors, ISO, scenario)
close all
...
%     close all
    ...
    filename = ['Outputs/',ISO,'/combined/scenario_',num2str(scenario),'/Histograms/',ISO,'_',char(fields(j)),'.png'];
    saveas(fig,filename)
...
filename = ['Outputs/',ISO,'/combined/scenario_',num2str(scenario),'/Histograms/',ISO,'_multi1.png'];
saveas(fig_multi1,filename)

filename = ['Outputs/',ISO,'/combined/scenario_',num2str(scenario),'/Histograms/',ISO,'_multi2.png'];
